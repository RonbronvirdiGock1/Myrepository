...
all_sprites = pyagme.sprite.Group()
...
while running:
    for event in pygame.event.get():
        ...
        if not won:
            ...
            x_change = (keys[pygame.K_RIGHT] - keys[pygame.K_LEFT]) * MOVEMNET_SPEED
            y_change = (keys[pygame.K_UP] - keys[pygame.K_DOWN]) * MOVEMNET_SPEED
